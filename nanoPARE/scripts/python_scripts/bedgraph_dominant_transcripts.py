...
def write_bedgraph_from_dict(input, output_filename, digits=2, parallel=False):
    ...
    def generate_bedgraph_lines(values_dict, chrom, queue, parallel=parallel):
        ...
        start = 0
        prevpos = 0
        prevcount = 0 #Tell Mathieu changed this from none to 0, due to changes in python language
        chromlen = len(input[chrom])
        position = 0 #Tell Mathieu changed this from none to 0, due to changes in python language
