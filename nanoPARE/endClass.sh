...
sample_name_array=( $(cut -f 4 $REFERENCE_TABLE) ) #Tell Mathieu removed -d specification because our file has tabs
sample_type_array=( $(cut -f 5 $REFERENCE_TABLE) ) #Tell Mathieu removed -d specification because our file has tabs
picked_from_table=()
