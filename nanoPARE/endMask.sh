...
sample_name_array=( $(cut -f 4 $REFERENCE_TABLE) ) #Tell Mathieu altered this for tab delimited
sample_type_array=( $(cut -f 5 $REFERENCE_TABLE) ) #Tell Mathieu altered this for tab delimited
picked_from_table=()
